...
public class ResponsiveTopologyTestDriver extends TopologyTestDriver {
  ...
  /**
   * Create a new test diver instance. Default test properties are used to initialize the driver
   * instance
   *
  ...
  public ResponsiveTopologyTestDriver(
      final Topology topology, final Instant initialWallClockTimeMs) {
   ...
   */
  public ResponsiveTopologyTestDriver(
      final Topology topology, final Properties config, final Instant initialWallClockTime) {
    super(topology, testDriverProps(config, topology.describe()), initialWallClockTime);
  }

  private static Properties testDriverProps(
      final Properties baseProps, final TopologyDescription topologyDescription) {
