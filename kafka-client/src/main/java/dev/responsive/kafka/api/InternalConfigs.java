...
public final class InternalConfigs {
  ...
  public static <T> T loadFromConfig(
    ...
    if (o == null) {
      final IllegalStateException fatalException = new IllegalStateException(name + " was missing");
  ...
  public static Admin loadKafkaAdmin(final Map<String, Object> configs) {
    return loadFromConfig(
        configs, InternalConfigs.INTERNAL_ADMIN_CLIENT_CONFIG, Admin.class, "Shared Admin client");
  }

  public static ResponsiveStoreRegistry loadStoreRegistry(final Map<String, Object> configs) {
    return loadFromConfig(
        configs, STORE_REGISTRY_CONFIG, ResponsiveStoreRegistry.class, "Store registry");
  }
