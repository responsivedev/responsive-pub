...
public abstract class DelegatingProcessorContext<KOut, VOut, D extends InternalProcessorContext<KOut, VOut> & FixedKeyProcessorContext<KOut, VOut>>
  ...
  public void logChange(
    ...
    delegate().logChange(
        storeName, key, value, timestamp, position
    );
  }
