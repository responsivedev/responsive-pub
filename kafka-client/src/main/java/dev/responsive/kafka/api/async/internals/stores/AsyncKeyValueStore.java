...
public class AsyncKeyValueStore<KS, VS> implements KeyValueStore<KS, VS> {
  ...
  public AsyncKeyValueStore(
      ...
      final AsyncProcessorContext<?, ?> asyncProcessorContext
  ) {
    ...
    this.asyncProcessorContext = asyncProcessorContext;
  }
  ...
  public void put(KS key, VS value) {
    ...
    final MergedProcessorContext<?, ?> rawThreadCtx = asyncProcessorContext.delegate();
    if (rawThreadCtx instanceof AsyncThreadProcessorContext) {
      ...
      final AsyncThreadProcessorContext<?, ?> threadCtx = (AsyncThreadProcessorContext<?, ?>)
          asyncProcessorContext.delegate();
