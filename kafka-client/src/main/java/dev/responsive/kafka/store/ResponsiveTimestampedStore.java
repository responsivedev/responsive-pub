...
/**
 * Timestamped version of the {@link ResponsiveStore} that just implements the {@link
 * TimestampedBytesStore} marker interface.
 *
 * <p>Since we don't have to worry about state being migrated from a non-timestamped to timestamped
