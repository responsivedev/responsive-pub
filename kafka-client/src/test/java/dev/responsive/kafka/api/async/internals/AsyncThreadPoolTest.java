...
class AsyncThreadPoolTest {
  ...
  public void shouldFinalizeEventWhenFinished()
    ...
    // when:
    final var futures = schedule("processor", 0, event);
  ...
  private List<CompletableFuture<AsyncEvent>> schedule(
      final String processor, final int task, final AsyncEvent... events) {
